...
namespace winrt::files::implementation
{
    ...
    void CustomTitleBar::UseCustomColors_Click(IInspectable const&, RoutedEventArgs const&)
    {
        UpdateColors();
    }

    void CustomTitleBar::UpdateColors()
    {
    ...
    event_token CustomTitleBar::PropertyChanged(PropertyChangedEventHandler const& handler)
    {
        return m_propertyChanged.add(handler);
    }

    void CustomTitleBar::PropertyChanged(event_token const& token) noexcept
    {
